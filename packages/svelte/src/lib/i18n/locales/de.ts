...
/** German (Deutsch) translations for the Traek library. */
export const de: TraekTranslations = {
	canvas: {
		...
		gestureHintDrag: 'Ziehen zum Verschieben',
		gestureHintZoom: 'Scrollen zum Zoomen'
	},
	input: {
	...
	zoom: {
		...
		snapToGrid: 'Raster-Ausrichtung umschalten',
		snapToGridEnabled: 'Raster: Ein',
		snapToGridDisabled: 'Raster: Aus'
	},
	search: {
		placeholder: 'Suchen...',
	...
	keyboard: {
		...
		switchFocusToInput: 'Eingabe fokussieren / Neue Nachricht',
		deleteFocusedNode: 'Fokussierten Knoten löschen',
		fitAllNodes: 'Alle Knoten einpassen',
		...
		vimNavigateUp: 'Zum übergeordneten Knoten',
	...
	mobile: {
		swipeUpHint: 'Nach oben wischen für mehr',
		swipeDownHint: 'Nach unten wischen um zurückzugehen',
		swipeLeftHint: 'Vorheriger Ast',
		swipeRightHint: 'Nächster Ast'
	},
	tour: {
		...
		panZoomTitle: 'Auf der Leinwand navigieren',
		panZoomDescription:
			'Ziehen zum Verschieben, Scrollen zum Zoomen (oder Pinch auf Trackpad). Strg+Scrollen zum präzisen Zoomen. Die Minimap in der Ecke zeigt deine Position.',
