...
/** Chinese Simplified (简体中文) translations for the Traek library. */
export const zh: TraekTranslations = {
	canvas: {
		...
		gestureHintDrag: '拖动以平移',
		gestureHintZoom: '滚动以缩放'
	},
	input: {
		placeholder: '向专家提问...',
		sendAriaLabel: '发送消息',
	...
	zoom: {
		...
		fitAllNodes: '适应所有节点',
		snapToGrid: '切换网格对齐',
		snapToGridEnabled: '网格对齐: 开',
		snapToGridDisabled: '网格对齐: 关'
	},
	search: {
		placeholder: '搜索...',
		noMatches: '无匹配结果',
	...
	keyboard: {
		...
		switchFocusToInput: '聚焦输入 / 新消息',
		deleteFocusedNode: '删除焦点节点',
		fitAllNodes: '适应所有节点',
	...
	mobile: {
		swipeUpHint: '向上滑动查看更多',
		swipeDownHint: '向下滑动返回',
		swipeLeftHint: '上一个分支',
		swipeRightHint: '下一个分支'
	},
	tour: {
		...
		panZoomTitle: '在画布上导航',
		panZoomDescription:
			'拖动以平移，滚动以缩放（或在触控板上双指捏合）。使用 Ctrl+滚动进行精确缩放。角落的缩略图显示您的位置。',
